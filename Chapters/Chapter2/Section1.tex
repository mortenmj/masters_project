...
\Cref{lst:inertial-codj} shows a direct implementation of \cref{eq:inertial}.
...
\Cref{fig:inertial-actuator} shows one such example, where the actuator from \cref{fig:inertial-architecture} is implemented as a simple model of an induction motor.
