...
\Cref{lst:matlab-replace} shows how to use this to replace the step function in \cref{fig:simulink-inertial-expanded}, to swap in a different source.
...
\Cref{fig:simscape-inertial} shows what our model looks like in Simscape.
...
\Cref{fig:simulink-inertial-order} shows the execution order for the model we have been working with.
